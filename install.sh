...
NIX_CONFIG="'experimental-features = nix-command flakes' 'trusted-substituters = https://chaotic-nyx.cachix.org' 'trusted-public-keys = chaotic-nyx.cachix.org-1:HfnXSw4pj95iI/n17rIDy40agHj12WfF+Gqk6SonIT8='"
